 ...
 *         &lt;element name="restoreAccounts" type="{http://www.w3.org/2001/XMLSchema}boolean"/>
...
@XmlRootElement(name = "restorePerson")
public class RestorePerson {
    ...
    protected boolean restoreAccounts;
    @XmlElement(required = true)
    ...
    /**
     * Gets the value of the restoreAccounts property.
     * 
     */
    public boolean isRestoreAccounts() {
        return restoreAccounts;
    }

    /**
     * Sets the value of the restoreAccounts property.
     * 
     */
    public void setRestoreAccounts(boolean value) {
        this.restoreAccounts = value;
    }
