 ...
 *         &lt;element name="targetContainer" type="{http://model.ws.itim.ibm.com}WSOrganizationalContainer"/>
...
@XmlRootElement(name = "transferPerson")
public class TransferPerson {
    ...
    @XmlElement(required = true)
    protected WSOrganizationalContainer targetContainer;
    @XmlElement(required = true)
     ...
     *     
     */
    public WSOrganizationalContainer getTargetContainer() {
     ...
     *     
     */
    public void setTargetContainer(WSOrganizationalContainer value) {
