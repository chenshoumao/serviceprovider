 ...
 *         &lt;element name="includeAccounts" type="{http://www.w3.org/2001/XMLSchema}boolean"/>
...
@XmlRootElement(name = "suspendPersonAdvanced")
public class SuspendPersonAdvanced {

    @XmlElement(required = true)
    protected WSSession session;
    @XmlElement(required = true)
    protected String personDN;
    protected boolean includeAccounts;
    @XmlElement(required = true)
     ...
     * 
     */
    public void setIncludeAccounts(boolean value) {
