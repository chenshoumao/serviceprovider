...
<body style="text-align:center;;background:#F0F0F0;">
	 ...
	 <tr><td><label >PO No.: </label></td><td> <input name="po_no" id="po" type="text"	data-options="required:true,validType:['length[3,15]', 'isExist']"  /></td><td><label >PO description:</label></td><td><input name="po_desc" id="desc" data-options="required:true"  /></td> </tr>	 
	 <tr> <td><label >Product type description:</label></td><td><input name="prod_type_desc" id="pro"	data-options="required:true"/></td><td></td><td></td></tr>	 
	 <tr> <td><label >Start time :</label></td ><td> <input name="start_time" id="start" type="text"data-options="required:true" />	</td><td><label>Complete time: </label></td><td> <input name="complete_time" id="comp" type="text" data-options="required:true"/></td></tr>	 
