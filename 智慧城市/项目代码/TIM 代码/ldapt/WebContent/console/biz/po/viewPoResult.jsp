...
$.getJSON(url11, function(res) {
    ...
    var filename = res[0].contract_upload;
...
<body style="text-align:center;;background:#F0F0F0;">
	 ...
	 <div style="width:100%;height:90px;font-size: 28px; font-weight: bold;">view result of Project Order</div>
	 <div style="border: 0px solid #ccc;">
	 <form id="fm" method="post" enctype="multipart/form-data" novalidate >
     <input name="approveResult" type="hidden">
     <input name="downPath" id="downPath" type="hidden">
	 <table style="margin:0 auto;">
	 <tr> <td><label >Customer:</label></td><td><input name="customer" readonly="readonly" id="cust" data-options="required:true"/></td> <td><label >Manufacturer:</label></td><td><input readonly="readonly" name="maufacturer" id="manu" data-options="required:true" /></td></tr>	 
	 ...
	 <tr> <td><label >Start time :</label></td ><td> <input name="start_time" id="start" type="text"data-options="required:true" />	</td><td><label>Complete time: </label></td><td> <input readonly="readonly" name="complete_time" id="comp" type="text" data-options="required:true"/></td></tr>	 
	 <tr> <td></td><td ><!--button type="button" onclick="save()" >Save</button--></td><td></td><td ><!--button type="button" >Approve</button--></tr>
	 <tr>
	 	<td>Opinion :</td>
		<td colspan="3" >
			<textarea readonly="readonly" id="opinion" style="width: 515px;"></textarea>
		</td>
	 </tr>
	 </table>  
	 </form> 
	 	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input name="filename" id="filename" type="text" data-options="required:true" disabled="disabled" style="height: 22px;width: 200px"/>
	 	<a class="easyui-linkbutton"  iconCls="icon-add" onclick="dowloadAccessory();">Dowload Accessory</a>
	 	<a class="easyui-linkbutton"  iconCls="icon-add" onclick="ReBuild();">ReBuild</a>
