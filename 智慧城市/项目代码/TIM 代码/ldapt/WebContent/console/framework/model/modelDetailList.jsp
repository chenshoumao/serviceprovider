...
<script type="text/javascript"src="<%=basePath %>scripts/framework/model/modelDetailList.js"></script>
<style type="text/css">
	html,body{
...
<body>
	<div style="text-align:center;width:100%;height:100%">
		<div id="modelPanel" class="easyui-panel" title="模型详细信息" data-options="footer:'#modelFooter',fit:true">
			<div id="tabs" class="easyui-tabs" style="height:100%;width:100%;" data-options="fit:true">
				<div id="modelTab"  title="模型属性" data-options="fit:true" >
					...
					<label>模型Id:</label>
					 <input id="modelId" name="modelId" value="${model.modelId}" class="easyui-textbox"
						required="true" style="width: 280px;" validtype="length[1,50]" invalidMessage="有效长度1-50" >

					</div>
					<div class="fitem">
					<label>模型中文名:</label>
					 <input id="modelCName" name="modelCName" value="${model.modelCName}"  class="easyui-textbox"
						required="true" style="width: 280px;" validtype="length[1,50]" invalidMessage="有效长度1-50" >

					</div>
					<div class="fitem">
					<label>模型英文名:</label>
					 <input id="modelEName" name="modelEName" value="${model.modelEName}" class="easyui-textbox"
						required="true" style="width: 280px;" validtype="length[1,50]" invalidMessage="有效长度1-50" >

					</div>
					<div class="fitem">
						<label>所属数据域:</label>
						 <input id="refDomainId"  name="${model.domain.domainCName}" value="${model.domain.domainId}" style="width: 280px;"	>
					</div>
					<div class="fitem">
					<label>是否主实体:</label>
					<input id="isMainEntity" name="isMainEntity" value="${model.isMainEntity}" type="checkbox" style="width:14px;" >
					</div>
					<div class="fitem">
						<label>模型描述:</label>
						<textarea  id="modelDesc" name="modelDesc"  style="width: 280px; height: 80px;border: 1px solid #95B8E7;border-radius: 5px 5px 5px 5px;">${model.modelDesc}</textarea>
					</div>
				</form>
				</div>
				...
				<div id="foreignTab"   title="外键列表" data-options="fit:true">
					...
					<div id="foreign_toolbox" style="padding:0px;height:25px">
						<div style="margin-bottom:5px;float:left">
			...
			<div id="attriDialog" class="easyui-dialog"  style="width:70%;" data-options="closed:true,buttons:'#attriFooter'" title="添加属性">
			...
			<div id="foreignDialog" class="easyui-dialog" data-options="closed:true,buttons:'#foreignFooter'"  style="width:70%;" title="添加外键" >
		...
		<div id="modelFooter" style="padding:5px;">
				<div style="float:right;">
					<a href="#" class="easyui-linkbutton" id="model_save"  iconCls="icon-ok" plain="true">保存</a>
					<a href="#" class="easyui-linkbutton" id="model_close"  iconCls="icon-cancel" plain="true">返回</a>
				</div>
		</div>
	...
	<div id="edit_foreignDialog" class="easyui-dialog"  style="width:70%;" data-options="model:true,closed:true,title:'修改外键',buttons:'#edit_foreignDialog_bt'">
		<form id="edit_foreignForm" method="post" class="fm" >
				<div class="fitem" style="display:none;">
					<label>外键ID:</label>
					 <input id="edit_fKId" name="edit_fKId" class="easyui-textbox"
						 style="width: 280px;"  >

				</div>
				<div class="fitem">
					<label>外键中文名:</label>
					 <input id="edit_fKCName" name="edit_fKCName" class="easyui-textbox"
						required="true" style="width: 280px;" validtype="length[1,50]" invalidMessage="有效长度1-50" >

				</div>
				<div class="fitem">
					<label>外键英文名:</label>
					 <input id="edit_fKEName" name="edit_fKEName" class="easyui-textbox"
						required="true" style="width: 280px;" validtype="length[1,50]" invalidMessage="有效长度1-50" >

				</div>
				<div class="fitem">
					<label>外键主属性:</label>
					 <input id="edit_fKMainAttribute" name="edit_fKMainAttribute" data-options="required:true" style="width: 280px;">

				</div>
				<div class="fitem">
					<label>外键参照模型:</label>
					 <input id="edit_refModelId" name="edit_refModelId" data-options="required:true" style="width: 280px;">
