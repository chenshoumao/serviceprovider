...
function Nav() {
    var strVar = "";
    strVar += "<ul>";
    strVar += " <a href=\"/wps/myportal/Home/indexPage\"><li class=\"NavSelect\">网站首页<\/li><\/a>";
    strVar += " <a href=\"/wps/myportal/Home/myspace\"><li>个人空间<\/li><\/a>";
    strVar += " <a href=\"/wps/myportal/Home/xinxicenter\"><li>信息中心<\/li><\/a>";
    strVar += " <a href=\"/wps/myportal/Home/companyOA\"><li>集团OA</li><\/li><\/a>";
    strVar += " <a href=\"/wps/myportal/Home/companyHR\"><li>集团HR</li><\/li><\/a>";
    strVar += "<\/ul>";
